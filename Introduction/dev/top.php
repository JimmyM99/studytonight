            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-7 mb-3" id="middle">
                    ...
                    <div class="mt-2 mb-3 ms-2">
                        ...
                        <a href="latest.php" class="me-3" style="text-decoration:none;color:black;font-size:19px;cursor:pointer;">Latest</a>
                        <a href="top.php" style="text-decoration:none;color:black;font-size:19px;font-weight:bold;cursor:pointer;">Top</a>
                    </div>
                    ...
                    <!-- Posts -->
                    <?php
                    $data_n = "SELECT * FROM posts ORDER BY RAND()";
                    $result = mysqli_query($con, $data_n);
