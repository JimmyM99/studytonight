...
<body style="background-color:#f5f5f5;">
    <div class="site-index">
        <div class="container mt-2" style="width:2000px;">
                ...
                <div class="col-lg-2 mb-3" id="left">
                    ...
                    <?php if (!isset($_SESSION['user']['id'])) { ?>
                        <div class="card mb-3 p-2">
                            ...
                            <a href="register.php" class="btn btn-outline-primary form-control">Create Account</a>
                            <a href="login.php" class="btn bg-transparent form-control">Login</a>
                        </div>
                    <?php } ?>
                    <!-- Links -->
                    <div class="mb-3" id="links">
                        ...
                        <?php if (isset($_SESSION['user']['id'])): ?>
                            ...
                            <p>
                                <a style="text-decoration:none; color:black; font-size:17px;" href="reading_list.php">
                                    <i class="bi bi-bookmark-fill me-1"></i>Reading List<span class="p-1 ms-1"
                                        style="border:1px solid gray;border-radius:7px;background-color:gray;"><?= $total_bkmks ?></span></a>
                            </p>
                        <?php else: ?>
                ...
                <div class="col-lg-7 mb-3" id="middle">
                    ...
                    <div class="mt-2 mb-3 ms-2">
                        <a href="index.php" class="me-3"
                            style="text-decoration:none;color:black;font-weight:bold;font-size:19px;cursor:pointer;">Relevant</a>
                        <a href="latest.php" class="me-3"
                            style="text-decoration:none;color:black;font-size:19px;cursor:pointer;">Latest</a>
                        <a href="top.php"
                    ...
                    <!-- Posts -->
                    <?php
                    $data_n = "SELECT * FROM posts ORDER BY updated_at DESC";
                    $result = mysqli_query($con, $data_n);

                    if (mysqli_num_rows($result) > 0) {
                        while ($post = mysqli_fetch_assoc($result)) {

                            $sel = "SELECT * FROM users WHERE id = '$post[user_id]' ";
                            $sol = mysqli_query($con, $sel);
                            ...
                            <div class="card mb-2">
                                <!--Post image-->
                                <div>
                                    <img class="mb-3" src="<?= $post['post_image'] ?>"
                                ...
                                <div class="card-body p-1 ms-5">
                                    <div>
                                        ...
                                        <a href="read.php?id=<?= $post['id'] ?>" style="color:green;">
